      ...
      child: FractionallySizedBox(
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
              gradient: LinearGradient(colors: [Color.fromARGB(255, 47, 0, 104), Color.fromARGB(255, 0, 71, 178),]),
    ...
    return Align(
      ...
      child: FractionallySizedBox(
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
              gradient: LinearGradient(colors: [Color.fromARGB(255, 51, 1, 101), Color.fromARGB(255, 11, 44, 94)],
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: const Text('The Gentlebot',
                style: TextStyle(
                  fontWeight: FontWeight.w500,
                  color: Colors.white
                ),
